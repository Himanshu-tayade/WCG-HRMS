...
const ManagerDashboard = () => {
  ...
  const fetchTimesheets = async () => {
    setLoading(true);
    try {
      const res = await fetch("https://wcg-hrms.onrender.com/api/timesheet/manager/pending", {
        method: "GET",
        headers: {
  ...
  const approveTimesheet = async (timesheet) => {
    try {
      const res = await fetch(
        `https://wcg-hrms.onrender.com/api/timesheet/manager/${timesheet.user._id}/approve`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
